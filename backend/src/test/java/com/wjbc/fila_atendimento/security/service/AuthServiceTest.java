...
class AuthServiceTest {
    ...
    void setUp() {
        ...
        authService = new AuthService(usuarioService, confirmationTokenRepository,
                new ConcurrentHashMap<>() {{ put("gmailSmtpService", emailSenderService); }}, "gmailSmtpService");
    }
    ...
    void testConfirmEmailSuccess() {
        ...
        when(usuarioService.criar(any(UsuarioCreateDTO.class))).thenReturn(new UsuarioResponseDTO(usuario.getId(), usuario.getNomeUsuario(), usuario.getEmail(), usuario.getCategoria(), null));
